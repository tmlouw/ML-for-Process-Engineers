...
%  distribution
%
%  The functions "EstimateError", "GenerateData", and
%  "CreatGaussDesignMatrix" are required to run all the scripts
...
p = 4;
AllData.X = x2fx(AllData.t, (1:p)'); % This time, we are adding our design matrix to the table "Train"
